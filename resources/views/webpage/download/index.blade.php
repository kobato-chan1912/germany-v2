...
[
    "og_title" => "Herunterladen mp3 $song->title",
    "og_des" => "",
    "title" => "Herunterladen mp3 $song->title"
])
        ...
        <script>
            $(document).ready(function () {
                $("#btnViewMore").on("click", function(e) {
                    ...
                    if ($(this).text() == "lihat lebih banyak") {
                        $(this).text("Runtuh");
                    } else {
                ...
                <div class="">
                    <div class="box">
                        ...
                        <div class="post_container">
                            ...
                            <div class="post_head">
                                <h1 class="post_name">Herunterladen {{$song->title}}</h1>
                                <script>
                                    var jQInit = jQInit || [];
                ...
                <div class="download-section">
                    <div id="download-ringtone" class="overlay">
                        <div class="title-download">
                            <h2>Herunterladen {{$song->title}} </h2>
                        </div>


                        <div class="popup">
                            <p class="title-report">Herunterladen</p>
                            ...
                            <div class="popup-content" style="display: flex;">
                                ...
                                <div class="box-cross mb-20">
                                    <div class="bc-title">{{$song->title}} Herunterladen</div>
                                    <div class="bc-body wrap-box-mod">
                                        ...
                                        <div class="links">
                                            <div class="item item-obb">
                                                <span>MP3 File:</span>
                                                <a href="{{route("dlDownload"). "?id=" .$song->id}}" class="btn btn-green">Herunterladen mp3</a>
                                            </div>
                        ...
                        <div class="download-err">
                            <span>Wenn der Download nicht in wenigen Sekunden beginnt, </span> <a href="{{route("dlDownload"). "?id=" .$song->id}}">klicken Sie hier !!!!</a>
                        </div>
                    </div>
                </div>
