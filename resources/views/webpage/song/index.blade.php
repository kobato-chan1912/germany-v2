            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="title single-breadcrumb">
                        ...
                        <div class="post_breadcrumbs"><span><span><a style="color: #a4c639 !important;"
                                                                     href="{{route("webPageIndex")}}">Home</a> » <span><a
                                            href="/{{$category->category_slug}}"
                                            style="color: #a4c639 !important;"> {{$category->category_name}}</a> » <strong
                                            class="breadcrumb_last" aria-current="page">{{$song->title}}</strong></span></span></span>
                        </div>
                    </div>
                    <div class="post_container" style="background-color: white">
                        ...
                        <div class="post_head">
                            ...
                            <div id="jquery_jplayer_1" class="jp-jplayer" style="width: 0px; height: 0px;"><img
                                ...
                                <audio id="jp_audio_0" preload="metadata" src="{{$song->url}}"></audio>
                            </div>
...
{{--                                    <span><a--}}
{{--                                            href="/{{$category->category_slug}}">{{$category->category_name}}</a> </span>--}}
{{--                                </div>--}}
                                ...
                                <div class="post_archive">
                                    ...
                                    <table class="table table-bordered" style="width: 100%">
                                        ...
                                        <tr>
                                            <th><b>Name</b></th>
                                            <td><h3 class="title-table">{{$song->title}}</h3></td>
                                        </tr>
                                        <tr>
                                            <th>Format</th>
                                            <td class="parameter">
                                        ...
                                        <tr>
                                            ...
                                            <td class="parameter">
                                                ...
                                                <i class="fa fa-eye" aria-hidden="true"></i> <span>{{$song->listeners}}</span>
                                                <i class="fa fa-download" aria-hidden="true"></i> <span>{{$song->downloads}}</span>                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Treffen</th>
                                            <td>
                                        ...
                                        <tr class="primary-category">
                                            ...
                                            <td>
                                                <div class="qrcode">
                                                    <img class=""
                                                         src="https://chart.googleapis.com/chart?chs=130x130&amp;cht=qr&amp;chl={{env("WEBPAGE_URL").$song->url}}"
                                                         alt="Código QR">
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <a id="btnModalx" href="/{{$song->category->category_slug}}/{{$song->slug}}/download/" class="btn_download" rel="nofollow"
                        ...
                        <div class="modal-dialog" role="document" style="max-width:490px; width:95%;">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="exampleModalLabel">{{$song->title}} ringtone
                                        download</h4>
                                </div>
                                <div class="modal-body">
                                    <div class="row" style="text-align:center;">
                                        <div class="col-md-6">
                                            <a href="/download/{{$song->id}}" style="padding: 8px;margin-top: 10px;"
                                               class="btn_download btn btn-success" target="_blank" rel="nofollow"
                                               title="Download">Download MP3<i class="fa fa-download"
                                                                               style="padding: 0 6px 0 6px; color:#fff; margin-left: 3px;"></i></a>
                                        </div>
                                        <div class="col-md-6">
                                            <a href="/download/{{$song->id}}" style="padding: 8px;margin-top: 10px;"
                                               class="btn_download btn btn-success" target="_blank" rel="nofollow"
                                               title="Download">Download M4R<i class="fa fa-download"
                                                                               style="padding: 0 6px 0 6px; color:#fff; margin-left: 3px;"></i></a>
                                        </div>
                ...
                <div class="box column-3">
                    <h3 class="title">{{$category->category_name}} mag auch mögen</h3>
                                ...
                                <div class="app_thumb">
                                    ...
                                    <div id="cp_container_{{$song->id}}" class="cp-container">
                                        ...
                                        <ul class="cp-controls">
                                            <li><a href="#" class="cp-play cp-play-{{$song->id}}" tabindex="1">play</a>
                                            </li>
