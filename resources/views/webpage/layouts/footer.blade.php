@php
    ...
    $youtube = \App\Models\Config::where("config_name", "youtube")->first()->config_value;
    $facebook = \App\Models\Config::where("config_name", "facebook")->first()->config_value;
    $twitter = \App\Models\Config::where("config_name", "twitter")->first()->config_value;
    $pinterest = \App\Models\Config::where("config_name", "pinterest")->first()->config_value;
    $telegram = \App\Models\Config::where("config_name", "telegram")->first()->config_value;
    $tiktok = \App\Models\Config::where("config_name", "tiktok")->first()->config_value;
...
{{--            </div>--}}
            <div class="copyright">
                <a href="/"><img class="img-fluid" src="/webpage/images/logo_v3.webp" width="100px" alt="logo"></a>
                <ul class="socials">
                    <li>
                    ...
                    <li>
                        <a class="social-facebook" href="{{$facebook}}"
                           target="_blank" rel="noopener">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    ...
                    <li>
                        <a class="social-twitter" href="{{$twitter}}"
                           target="_blank" rel="noopener">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    ...
                    <li>
                        <a class="social-printerest" href="{{$pinterest}}"
                           target="_blank" rel="noopener">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    ...
                    <li>
                        <a class="social-telegram" href="{{$telegram}}"  target="_blank" rel="noopener">
                    ...
                    <li>
                        <a class="social-telegram" href="{{$tiktok}}"  target="_blank" rel="noopener">
